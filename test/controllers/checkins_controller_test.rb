...
class CheckinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkin" do
    assert_difference("Checkin.count") do
      post checkins_url, params: { checkin: { checked_in: @checkin.checked_in, date: @checkin.date, habit_id: @checkin.habit_id, user_id: @checkin.user_id } }
    end
  ...
  test "should update checkin" do
    patch checkin_url(@checkin), params: { checkin: { checked_in: @checkin.checked_in, date: @checkin.date, habit_id: @checkin.habit_id, user_id: @checkin.user_id } }
